...
from .forms import generos #terminar
...
def alumnosUpdate(request):
    ...
    def generosAdd(request):
        ...
        if request.method == "POST":
            ...
            if form.is_valid:
                ...
                context = {"mensaje" : "Genero guardado exitosamente", "form":form}
    ...
    def generos_del(request, pk):
        ...
        try:
            ...
            if genero:
                genero.delete()
                mensaje.append("Bien , genero eliminado satisfactoriamente")
                context = {"generos": generos,"mensajes":mensajes,"errores":errores}
                return render(request, "generos/generos_list.html", context)
        except:
            genero = Genero.objects.all()
            mensajes = "Error, el id no existe para ser eliminado"
            context = {"mensajes": mensajes, "generos": generos}
            return render(request, "generos/generos_list.html", context)
        ...
        try:
            ...
            if genero:
                if request.method == "POST":
                    ...
                    form = GeneroForm(instnce=genero)
                    mensaje = ""
                    context = {"genero":genero, "form": form, "mensaje": mesnajes}
                    return render(request, "generos.generos_edit.html", context)
        except:
            generos =Genero.objects.all()
            mensajes = "Error, el id no existe"
            context = {"mensaje": mensajes, "form": form}
            return render(request, "generos.generos_edit.html", context)